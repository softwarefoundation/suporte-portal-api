...
public class ExceptionHandling {
    ...
    private static final String METHOD_IS_NOT_ALLOWED = "Método não permitido. Envie '%s' request";
    ...
    private ResponseEntity<HttpResponse> accountDisabledException(){
        return createHttpResponse(HttpStatus.BAD_REQUEST, ACOUNT_DISABLED);
    }
